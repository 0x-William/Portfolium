...
@implementation PFEntryLandingViewItem

+ (NSString *)preferredReuseIdentifier; {
    
    return @"PFEntryLandingViewItem";
}
...
- (id)initWithFrame:(CGRect)frame; {
    ...
    if (self) {
        ...
        PFEntryLandingView *entryView = [[PFEntryLandingView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
